...
export function ShareMatchDialog({
  ...
  const matchUrl =
    typeof window !== "undefined"
      ...
      : `https://getcancha.up.railway.app/matches/${match.id}`;
      ...
      <DialogContent showCloseButton={false}>
        <DialogHeader>
          ...
          <DialogDescription className="text-center">
            Compártelo para que se llene
          </DialogDescription>
        </DialogHeader>

        <div className="space-y-3 pt-2">
          <Button
            className="w-full bg-[#25D366] hover:bg-[#1ebe57] text-white text-base py-6"
            onClick={handleWhatsApp}
          >
            <svg
              viewBox="0 0 24 24"
              className="h-5 w-5 fill-current mr-2 shrink-0"
            >
